...
export function HomePage({ userProfile, imminentActivity, exams }: HomePageProps) {
  const quickActions = [
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] pb-24">
      ...
      <div className="flex items-center justify-between px-5 pt-6 pb-3">
        <h1 className="text-[1.7rem] font-light text-[#0F3352] tracking-tight">Io e il Polimi</h1>
        <a href="#" className="text-[1.1rem] font-light text-[#0F3352] flex items-center gap-1 hover:underline">
          Servizi Online <ArrowUpRight className="w-4 h-4" />
        </a>
      </div>
